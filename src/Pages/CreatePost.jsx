    ...
    if (form.prompt) {
      try {
        ...
        const response = await fetch(
          "https://ai-server-six.vercel.app/api/v1/picChai",
          {
            method: "POST",
            headers: {
      ...
      Swal.fire("Please provide proper prompt", "", "error");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        ...
        await response.json();
        Swal.fire("You Post is done", "", "success");
        navigate("/");
      } catch (err) {
        Swal.fire(`${err}`, "", "error");
      } finally {
      ...
      Swal.fire(`Please generate an image with proper details`, "", "error");
    }
  };
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          Create imaginative and visually stunning images generated by Pic-Chai
